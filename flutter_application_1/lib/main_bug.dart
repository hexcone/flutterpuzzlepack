...
class _PuzzleState extends State<Puzzle> {
  ...
  Widget buildTileGrid(double tileDimension) {
    final items = [
      Rive(artboard: _riveArtboard!,),  //tile 1
      ...
      Rive(artboard: _riveArtboard!,),
      Rive(artboard: _riveArtboard!,),
      Rive(artboard: _riveArtboard!,),  //tile 8
      Rive(artboard: _riveArtboard!,),
      Rive(artboard: _riveArtboard!,),
      Rive(artboard: _riveArtboard!,),
      Rive(artboard: _riveArtboard!,),
      ...
      Rive(artboard: _riveArtboard!,),
      Rive(artboard: _riveArtboard!,),
      Rive(artboard: _riveArtboard!,),  //tile 16
    ];
          ...
          GestureDetector(
            onTapDown: (_) {
              ...
              for(int i=0;i<animationPlaylist.length;i++) {
                  ...
                  _indexes?[i].value = animationPlaylist[i][0].toDouble();
                  print("yo" + (_indexes?[i].value).toString());
                  _rows?[i].value = animationPlaylist[i][1] == 1 ? true : false;
                  _columns?[i].value = animationPlaylist[i][2] == 1 ? true : false;
                  _moves?[i].value = animationPlaylist[i][3] == 1 ? true : false;
